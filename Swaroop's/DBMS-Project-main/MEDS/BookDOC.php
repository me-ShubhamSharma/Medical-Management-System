...
// $patlocation = $_SESSION['PAT_LOCATION'];

$query1 = "update patient
set  D_ID=$id where email='$patemail' and password ='$patpassword' ";
...
$query3 = "update patient set  P_ID=$P_ID where email='$patemail' and password ='$patpassword'";
