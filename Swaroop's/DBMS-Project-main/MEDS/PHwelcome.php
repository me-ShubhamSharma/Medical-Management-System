...
<body>
        ...
        <nav class="navbar">
            ...
            <div class="links">
                <ul class="unlist1">
                    <li>
                        <div class="dropdiv">
                            <a target="_blank" class="suplist1" href="#">EMPLOYEES</a>
                            <div class="hidlist">
                                <ul class="unlist">
                                    <li>
                                        <button><a target="_blank" class="list2" href="EmployeeADD.php">ADD EMPLOYEE</a></button>
                                    </li>
                                    <li>
                                        <button><a target="_blank" class="list2" href="EmployeeDisplay.php">List</a></button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <li class="dropdown">
                        <a target="_blank" class="list1" href="ADDmeds.php">ADD MEDCINE</a>
                    </li>
                    <form action="" method="post">


                        <li class="dropdown">
                            <a target="_blank" class="list1" href="PHdocD.php">DOCTORS</a>
                        </li>
                    </form>
                    <li>
    ...
    ?>
    <section>
        <h2 style="color:#fff; margin-top:2px; text-align:center">PRESCRIPTIONS</h2>
