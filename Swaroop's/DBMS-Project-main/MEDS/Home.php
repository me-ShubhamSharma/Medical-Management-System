      ...
      <div class="links">
        <ul class="ullists">
          <li id="doctid" class="linklist">
            <a target="_blank" class="link1" href="PharmacyRIG.php">Pharmacy</a>
          </li>
          <li target="_blank" id="pharid" class="linklist">
            <a target="_blank" class="link1" href="PatientRIG.php">Patient</a>
          </li>
          <li id="signid" class="linklist">
            <a target="_blank" id="dropalink" class="link1" href="DoctorRIG.php">Doctor</a>
          </li>
        </ul>
      </div>
    </nav>
