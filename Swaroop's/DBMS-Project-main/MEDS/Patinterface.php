...
<head>
  ...
  <link rel="stylesheet" href="css/Patinterface.css" />
  <title>Patient</title>
</head>
...
<body>
      ...
      <div class="links">
        <ul class="ullists">
          <li id="doctid" class="linklist">
            <a target="_blank" class="link1" href="PharmacyDisplay.php">Pharmacy</a>
          </li>
          <li target="_blank" id="pharid" class="linklist">
            <a class="link1" href="PatientRIG.php">Prescriptions</a>
          </li>
          <li>
            <a class="link1" id="logout" href="PHlogout.php">Logout &nbsp&nbsp&nbsp<i class="fa fa-sign-out" aria-hidden="true"></i></a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <section>
    <h2 id="tablehead">PRESCRIPTIONS</h2>
