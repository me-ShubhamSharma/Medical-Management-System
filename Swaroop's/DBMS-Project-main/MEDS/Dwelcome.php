...
<body>
        ...
        <nav class="navbar">
            ...
            <div class="links">
                <ul class="unlist1">
                    <li>
                        <div class="dropdiv">
                            <a target="_blank" class="suplist1" href="#">Medicines</a>

                        </div>
                    </li>
                    <li class="dropdown">
                        <a target="_blank" class="list1" href="PharmacyDisplay.php">Pharmacy</a>
                    </li>
                    <li>
    ...
    <section>
        <h2 style="color:#fff;display: flex; align-content:center; justify-content: center;">Appointments</h2>
