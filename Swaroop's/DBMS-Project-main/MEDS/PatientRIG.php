            ...
            <form action="" method="post">
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <input type="text" name=" PAT_NAME" value="<?php echo $PAT_NAME; ?>" placeholder="Enter Name" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Age</span>
                        <input type="text" name="AGE" value="<?php echo $AGE; ?>" placeholder="Enter Age" required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="PAT_LOCATION" value="<?php echo $PAT_LOCATION; ?>" placeholder="Enter Location" required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="email" value="<?php echo $email; ?>" placeholder="Enter Email ID" required>
                    </div>
                    <div class="input-box">
